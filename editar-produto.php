<?php
    ...
    if(isset($_POST['editar'])){
        ...
        $produto = $repositorio->buscar($_GET['id']);
...
<main>
  ...
  <section class="container-form">
    <form method="post">
      ...
      <input type="text" id="nome" name="nome"  placeholder="Digite um nome para o produto" value="<?= $produto->getNome() ?>" required>
      ...
      <input type="text" id="preco" name="preco" placeholder="Digite o preço do produto" value="<?= $produto->getPrecoFormated() ?>" required>

      <label for="imagem">Envie uma imagem do produto</label>
      <input type="file" name="imagem" accept="image/*" id="imagem" placeholder="Envie uma imagem">
        <input type="hidden" name="id" value="<?= $produto->getId() ?>">
      <input name="editar" type="submit" name="editar" class="botao-cadastrar"  value="Editar produto"/>
    </form>
